...
Template.postsList.helpers({  posts: function() {    return Posts.find({}, {sort: {submitted: -1}, limit: postsHandle.limit()} )  
},  
postsReady: function() {    
...
Template.postsList.events({  'click .load-more': function(e) {    e.preventDefault();    postsHandle.loadNextPage();  } });
